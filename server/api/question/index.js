...
router.put('/:id/answers/:answerId/solved', auth.isAuthenticated(), controller.solved);
router.delete('/:id/answers/:answerId/solved', auth.isAuthenticated(), controller.unsolved);
